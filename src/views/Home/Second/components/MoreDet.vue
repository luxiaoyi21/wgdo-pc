    ...
    <div class="item">
        ...
        <div class="content">
            <div class="content-in">
                ...
                <p class="dynamic" v-if="showDynamicContent">{{ $t('second.green') }}</p>
                <div class="dsc-line" style="margin-top: 15px; margin-bottom: 5px;" v-if="showDynamicContent"></div>
...
export default {
    ...
    mounted() {
        ...
        if (this.$route.path === '/sedmore/sedmoreinfo') {

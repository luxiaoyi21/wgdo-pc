    ...
    <div class="item">
        ...
        <div class="content">
            <div class="content-in">
                ...
                <p class="dynamic">绿色设计观点</p>

                <div class="dsc-line" style="margin-top: 15px; margin-bottom: 5px;"></div>
                <div class="dsc-line" style=""></div>

                <div class="dynamic-dsc">
                    <a :href="dym.externalLink" class="dynamic-content" v-for="dym in moredetDatas"
...
export default {
    name: "MoreDet",
    components: { Headers, Footers,Breadcrumb },
    data() {
        return {
            moredetDatas: [...this.$router.history.current.params.datas],
            // currentPage: 1,
            totalItems: 0,
            // pageSize: 10,
        };
    ...
    mounted() {
        // 这条是传过来的数据
        console.log(this.$router.history.current.params.datas);
        this.getMoredetData()
    },
    computed: {
        // currentTabDatas() {

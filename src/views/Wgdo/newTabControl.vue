<template>
    <div class="tc">
        <el-tabs class="ets" v-model="activeName" @tab-click="handleClick">
            ...
            <Intro v-if="currentNum === 1" :tabDatas="localDatas" />
            <Branch v-if="currentNum === 2" :tabDatas="localDatas" />
            <Service v-if="currentNum === 3" :tabDatas="localDatas" />
            <Train v-if="currentNum === 4" :tabDatas="localDatas" />
            <Policy v-if="currentNum === 5" :tabDatas="localDatas" />
        </el-tabs>
    </div>
</template>
...
export default {
    name: 'Tc',
    components: { Breadcrumb, Intro, Branch, Service, Train, Policy },

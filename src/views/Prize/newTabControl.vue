<template>
    <div class="tc">
        <el-tabs class="ets" v-model="activeName" @tab-click="handleClick">
            ...
            <Big v-if="currentNum === 1" :tabDatas="localDatas" />
            <Contribute v-if="currentNum === 2" :tabDatas="localDatas" />
            <!-- <Rule v-if="currentNum === 3" :tabDatas="localDatas" />
            <Personal v-if="currentNum === 4" :tabDatas="localDatas" />
            <Mechanism v-if="currentNum === 5" :tabDatas="localDatas" /> -->
        </el-tabs>
    </div>
</template>
...
export default {
    name: 'Tc',
    components: { Breadcrumb, Big, Contribute, Rule, Personal, Mechanism },

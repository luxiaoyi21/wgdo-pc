                ...
                <div v-for="info in infoDatas" :key="info.conferenceId">
                    ...
                    <div class="address">
                        <!-- <div class="address-left">
                            <img src="https://img.js.design/assets/img/662775561e96d9217229fd2f.jpg#6a2768da4f7e12c6735e26823d148748"
                                alt="">
                        </div> -->
...
export default {
    ...
    mounted() {
        ...
        var initialTop = -7.4 * window.innerWidth * 0.01;
        var initialRight = -16.63295 * window.innerWidth * 0.01;
        ...
        window.addEventListener('scroll', function () {
            ...
            if (currentScrollPos === prevScrollPos) {
                leader.style.top = initialTop + 'px';
                leader.style.right = initialRight + 'px';
            } else {
                var scrollY = currentScrollPos;
                leader.style.top = (scrollY - 300) + 'px';
            }
            ...
            Meet({ moduleType: '1', status: '1', version: p, id: id }).then(res => {
                if (res.data && Array.isArray(res.data.rows) && res.data.rows.length > 0) {
                    ...
                    res.data.rows.forEach(rows => {
                        if (rows.conferenceId === id) {
                            this.infoDatas.push(rows);
                        }
                    });
                }
            })

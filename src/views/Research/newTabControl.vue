<template>
    <div class="tc">
        <el-tabs class="ets" v-model="activeName" @tab-click="handleClick">
            ...
            <Design v-if="currentNum === 1" :tabDatas="localDatas" />
            <!-- <Designinfo v-if="currentNum === '绿色设计报告详情'" :tabDatas="tabDatas" /> -->
            <Standard v-if="currentNum === 2" :tabDatas="localDatas" />
            <Laboratory v-if="currentNum === 3" :tabDatas="localDatas" />
            <Resource v-if="currentNum === 4" :tabDatas="localDatas" />
        </el-tabs>
    </div>
</template>
...
export default {
    name: 'Tc',
    components: { Breadcrumb, Design, Standard, Laboratory, Resource, Designinfo },
